...
これで\ovalbox{main_odd.pdf}、\ovalbox{main_even.pdf}が生成されれば成功です。
...
新しいバージョンでは\ovalbox{main_odd.tex}と\ovalbox{main_even.tex}にドキュメントクラスを設定し、\ovalbox{\input{main.tex}}を
